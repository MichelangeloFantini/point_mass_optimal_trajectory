...
def compute_alpha(x0, v0, xf, vf, a_max, a_min, v_max, v_min, tf, previous_results):
    ...
    old_a0, old_a1, old_a2, old_a3, old_a4, old_a5, old_tf, old_ts, old_ts_1 = previous_results
    results = []
    a0 = x0
    a1 = v0
